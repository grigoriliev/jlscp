...
/**
 * The listener interface that is notified when the number of MIDI
 * instruments in a MIDI instrument map is changed.
 * @author Grigor Iliev
 */
public interface MidiInstrumentCountListener extends java.util.EventListener {
	/** Invoked when the number of MIDI instruments in a MIDI instrument map is changed. */
	public void instrumentCountChanged(MidiInstrumentCountEvent e);
}
